...
# # Assuming concatenated_df has columns for each individual's counts
# trace_mark = go.Bar(
#     xaxis='x4',
#     yaxis='y4',
#     y=concatenated_df["YearMonth"],
#     x=concatenated_df["Mark"],
#     orientation='h',
#     name="Mark",
#     hovertemplate='<b>Month: %{y}</b><br>Mark: %{x}<extra></extra>',
#     marker=dict(color='blue', line=dict(color='darkblue', width=2))
# )
...
#     yaxis='y4',
#     y=concatenated_df["YearMonth"],
#     x=concatenated_df["Sam"],
#     orientation='h',
#     name="Sam",
#     hovertemplate='<b>Month: %{y}</b><br>Sam: %{x}<extra></extra>',
...
#     yaxis='y4',
#     y=concatenated_df["YearMonth"],
#     x=concatenated_df["Russel"],
#     orientation='h',
#     name="Russel",
#     hovertemplate='<b>Month: %{y}</b><br>Russel: %{x}<extra></extra>',
#     marker=dict(color='green', line=dict(color='darkgreen', width=2))
# )
...
#     yaxis='y4',
#     y=concatenated_df["YearMonth"],
#     x=concatenated_df["Jake"],
#     orientation='h',
#     name="Jake",
#     hovertemplate='<b>Month: %{y}</b><br>Jake: %{x}<extra></extra>',
#     marker=dict(color='orange', line=dict(color='darkorange', width=2))
# )

# # Combine all traces
# fig = go.Figure([trace_mark, trace_sam, trace_russel, trace_jake])

# # Update layout to stack bars
# fig.update_layout(
#     barmode='stack',
#     title="Monthly Weight Distribution by Person",
...
layout1 = dict(
    ...
    xaxis4=dict(domain=[0.766, 1], showticklabels=False, showgrid=False),
    ...
    yaxis4=dict(domain=[0, 0.495], showticklabels=False, showgrid=False),
